...
from vacation_planner.crew import VacationPlanner  # Replace path 1
...
if submitted and destination:
    with st.spinner(
        "🌍 Planning your amazing vacation... This may take a few minutes."
    ):
        try:
...
with st.sidebar:
    ...
    features = [
        (
            ...
            "Finds interesting facts and hidden gems",
            "#667eea",
            "#764ba2",
        ),
        (
            "📋 Create detailed itineraries",
            "Plans your daily activities",
            "#f093fb",
            "#f5576c",
        ),
        (
            "🍽️ Recommend local foods",
            "Suggests must-try culinary experiences",
            "#4facfe",
            "#00f2fe",
        ),
